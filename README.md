...
- Production : https://api.aetherroyale.crzgames.com
- Staging : https://staging.api.aetherroyale.crzgames.com
...
```bash
git clone git@github.com:CrzGames/AetherRoyale_Backend.git
```
