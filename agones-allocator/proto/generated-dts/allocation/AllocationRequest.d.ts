...
export declare const _allocation_AllocationRequest_SchedulingStrategy: {
    readonly Packed: "Packed";
    readonly Distributed: "Distributed";
};
export type _allocation_AllocationRequest_SchedulingStrategy = 'Packed' | 0 | 'Distributed' | 1;
...
export interface AllocationRequest {
     ...
     */
    'counters'?: ({
        [key: string]: _allocation_CounterAction;
    });
    'lists'?: ({
        [key: string]: _allocation_ListAction;
    });
}
export interface AllocationRequest__Output {
     ...
     */
    'counters': ({
        [key: string]: _allocation_CounterAction__Output;
    });
    'lists': ({
        [key: string]: _allocation_ListAction__Output;
    });
}
