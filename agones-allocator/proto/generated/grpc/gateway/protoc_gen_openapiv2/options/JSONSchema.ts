...
export const _grpc_gateway_protoc_gen_openapiv2_options_JSONSchema_JSONSchemaSimpleTypes = {
  UNKNOWN: 'UNKNOWN',
  ARRAY: 'ARRAY',
  BOOLEAN: 'BOOLEAN',
  INTEGER: 'INTEGER',
...
export type _grpc_gateway_protoc_gen_openapiv2_options_JSONSchema_JSONSchemaSimpleTypes =
  | 'UNKNOWN'
  | 0
  | 'ARRAY'
  | 1
