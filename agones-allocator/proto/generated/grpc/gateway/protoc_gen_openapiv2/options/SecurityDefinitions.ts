...
export interface SecurityDefinitions {
   ...
   * defines.
   */
  'security'?: ({[key: string]: _grpc_gateway_protoc_gen_openapiv2_options_SecurityScheme});
}
...
export interface SecurityDefinitions__Output {
   ...
   * defines.
   */
  'security': ({[key: string]: _grpc_gateway_protoc_gen_openapiv2_options_SecurityScheme__Output});
}
