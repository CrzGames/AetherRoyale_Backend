 ...
 */
export declare const _grpc_gateway_protoc_gen_openapiv2_options_SecurityScheme_Flow: {
    readonly FLOW_INVALID: "FLOW_INVALID";
    readonly FLOW_IMPLICIT: "FLOW_IMPLICIT";
    readonly FLOW_PASSWORD: "FLOW_PASSWORD";
    readonly FLOW_APPLICATION: "FLOW_APPLICATION";
    readonly FLOW_ACCESS_CODE: "FLOW_ACCESS_CODE";
};
/**
 * The flow used by the OAuth2 security scheme. Valid values are
 * "implicit", "password", "application" or "accessCode".
 */
export type _grpc_gateway_protoc_gen_openapiv2_options_SecurityScheme_Flow = 'FLOW_INVALID' | 0 | 'FLOW_IMPLICIT' | 1 | 'FLOW_PASSWORD' | 2 | 'FLOW_APPLICATION' | 3 | 'FLOW_ACCESS_CODE' | 4;
/**
 * The flow used by the OAuth2 security scheme. Valid values are
 * "implicit", "password", "application" or "accessCode".
 */
 ...
 */
export declare const _grpc_gateway_protoc_gen_openapiv2_options_SecurityScheme_In: {
    readonly IN_INVALID: "IN_INVALID";
    readonly IN_QUERY: "IN_QUERY";
    readonly IN_HEADER: "IN_HEADER";
};
/**
 * The location of the API key. Valid values are "query" or "header".
 */
export type _grpc_gateway_protoc_gen_openapiv2_options_SecurityScheme_In = 'IN_INVALID' | 0 | 'IN_QUERY' | 1 | 'IN_HEADER' | 2;
/**
 * The location of the API key. Valid values are "query" or "header".
 */
 ...
 * "apiKey" or "oauth2".
 */
export declare const _grpc_gateway_protoc_gen_openapiv2_options_SecurityScheme_Type: {
    readonly TYPE_INVALID: "TYPE_INVALID";
    readonly TYPE_BASIC: "TYPE_BASIC";
    readonly TYPE_API_KEY: "TYPE_API_KEY";
    readonly TYPE_OAUTH2: "TYPE_OAUTH2";
};
/**
 * The type of the security scheme. Valid values are "basic",
 * "apiKey" or "oauth2".
 */
export type _grpc_gateway_protoc_gen_openapiv2_options_SecurityScheme_Type = 'TYPE_INVALID' | 0 | 'TYPE_BASIC' | 1 | 'TYPE_API_KEY' | 2 | 'TYPE_OAUTH2' | 3;
/**
 * The type of the security scheme. Valid values are "basic",
 * "apiKey" or "oauth2".
 */
