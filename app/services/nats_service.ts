...
export default class NatsService {
  ...
  public async connect(): Promise<void> {
    try {
      ...
      this.nc = await connect({
        ...
        /**
         * IMPORTANT: Ces options sont importantes pour maintenir la connexion active
         * et éviter les déconnexions dues à l'inactivité.
         */
   ...
   * @param {string} queue - Nom de la file d'attente (les abonnements sur le même sujet qui utilisent des files d'attente bénéficient d'un équilibrage de charge horizontal lorsqu'ils font partie de la même file d'attente)
