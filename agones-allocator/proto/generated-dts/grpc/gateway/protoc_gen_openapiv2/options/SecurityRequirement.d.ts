...
export interface SecurityRequirement {
    ...
    'security_requirement'?: ({
        [key: string]: _grpc_gateway_protoc_gen_openapiv2_options_SecurityRequirement_SecurityRequirementValue;
    });
}
/**
 * `SecurityRequirement` is a representation of OpenAPI v2 specification's
...
export interface SecurityRequirement__Output {
     ...
     */
    'security_requirement': ({
        [key: string]: _grpc_gateway_protoc_gen_openapiv2_options_SecurityRequirement_SecurityRequirementValue__Output;
    });
}
